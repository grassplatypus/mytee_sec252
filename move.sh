...
sudo cp ./mytee_examples/toctou_attack/toctou_victim.ko /media/`whoami`/rootfs/rootfs
sudo cp ./mytee_examples/toctou_attack/toctou_attacker.ko /media/`whoami`/rootfs/rootfs
